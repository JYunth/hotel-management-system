...
class CheckOut:
    def __init__(self, root):
        ...
        # create home button
        self.home_button = Button(bottom, text="Home", font=('Bookman Old Style', 15), bg="#330000", relief=RIDGE, height=2, width=15, fg="white", anchor="center", command=main.home_ui)
